...
public class View {
	...
	// private TextField firstNameTextField, lastNameTextField, idTextField,
	// fatherNameTextField, motherNameTextField;
	...
	// vb.getChildren().addAll(menuText, enterIdText, idTextField, bSearchStudent,
	// bAddStudent);
